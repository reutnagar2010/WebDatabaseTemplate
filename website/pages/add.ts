...
//   if (movieName == "" || imageUrl == "" || description == "" || type == "" || duration == "" || age == "" || year == "" || ticketPrice == "" ) {
...
//   await send("addMovie", movieName, imageUrl, description, parseInt(type), parseInt(duration), parseInt(age), parseInt(year), parseInt(ticketPrice));
